                        ...
                        std::size_t index)
{
  if (index >= size)
  {
    lserr << u8"The regex is not compelete." >> std::string(regex_ptr, size);
    throw 1;
  }
}
                              ...
                              std::size_t index)
{
  ...
  {
    lserr << u8"Regex syntax error! A number is needed." >> std::string(regex_ptr, index);
    throw 1;
  }
}
                            ...
                            const char c)
{
  ...
  lserr << u8"The regex is not compelete." >> std::string(regex_ptr, index, size);
  throw 1;
  return false;
}
